...
Existen diferentes técnicas que permiten hacer este etiquetado de forma automática y que difieren en el modelo matemático empleado para ello. En la web https://nlp.stanford.edu/links/statnlp.html#Taggers aparecen herramientas asociadas con distintos modelos para hacer esta tarea.
...
A continuación se describen las principales características de ambos y se comparan sus resultados a través del etiquetado del siguiente **texto extraido de Corpus de Brown**:
...
En la web http://www.cis.uni-muenchen.de/~schmid/tools/TreeTaggerse pueden encontrar todos los detalles acerca de este método de POS tagging así como descargar el programa que permite hacer este etiquetado.
